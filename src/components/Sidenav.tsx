...
export default function Sidenav() {
    ...
    return (
        <>
            ...
            <nav className={` ${showNav ? 'opacity-100 delay-500' : 'opacity-0 xl:opacity-100'} transition-all duration-300 ease-in-out xl:block fixed lg:static top-14 md:top-0 z-[102] h-[70vh] lg:h-full`}>
