...
export const Popup = ({children, label = "Dialog"} : PopupProps) => {
  return ReactDom.createPortal(
    <div
      className="absolute flex flex-col justify-center items-center z-50 inset-0 bg-gray-400 bg-opacity-50"
      role="dialog"
      aria-modal="true"
      aria-label={label}
    >
