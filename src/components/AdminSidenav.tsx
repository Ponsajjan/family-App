...
export default function AdminSidenav() {
    ...
    return (
        <>
            ...
            <nav className={` ${showNav ? 'opacity-100 delay-500' : 'opacity-0 xl:opacity-100'} transition-all duration-300 ease-in-out xl:block fixed top-14 lg:static md:top-0 z-[102] h-[70vh] lg:h-full`}>
