    ...
    return (
        <form className="text-text_color relative" onSubmit={handleSubmit}>
            ...
            <div className="w-full">
                ...
                {formData.verified && <p className='mt-2'><span className='inline-block align-bottom'><Info /></span>This member is already verified. Any changes will require moderator approval before they take effect.</p>}
            </div>
