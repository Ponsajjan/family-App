    ...
    return (
        <form className="text-text_color relative" onSubmit={handleSubmit}>
            ...
            <div className="w-full">
                <label htmlFor="member-name-input" className="text-sm font-medium block mb-1">Name</label>
                <div className={`border border-border_color z-0 rounded-md overflow-hidden bg-field_color flex items-center relative ${!formData.id && 'outline-2 outline-dashed outline-offset-2 outline-border_active'}`}>
                    ...
                    <button
                        ...
                        className="cursor-pointer bg-main_background z-50 border border-border_color px-1 flex justify-center items-center rounded-md w-fit h-8 mr-[0.125rem]"
                    >
                        <ChangeMember />
                    </button>
                </div>
            ...
            <div className='relative py-2'>
                ...
                <div className={`${showDeathDetails} pt-2`}>
                    <p id="dod-label" className="text-sm font-medium">Date Of Death</p>
            ...
            <div className='mt-8 mb-4'>
                {submitError && <p role="alert" className="text-text_color text-sm mb-2 flex items-start gap-1"><span className='-mt-0.5'><Error /></span><span dangerouslySetInnerHTML={{ __html: submitError }} /></p>}
