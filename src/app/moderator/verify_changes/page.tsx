  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full md:flex">
        ...
        />
        <div className={`md:static z-[101] fixed left-0 right-0 top-full bg-main_background ${showDetails ? 'md:border-l md:border-border_color z-[100] rounded-t-md md:rounded-none -translate-y-full md:translate-y-0' : 'md:w-0 translate-y-0 overflow-hidden'} transition-all duration-500 ease-in-out w-full h-[70vh] overflow-y-auto lg:max-w-[40%] mx-auto md:h-[calc(100vh-3rem)]`}>
