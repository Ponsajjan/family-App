          ...
          <div className="w-full max-w-3xl mx-auto mt-6">
            <div className="bg-field_color border border-border_color rounded-t-md text-text_color">
              <div className="flex items-center justify-between">
                <button
                  className="font-light py-2 px-3 cursor-pointer rounded-tl-md md:hover:bg-field_hover"
                ...
                <button
                  className="font-light py-2 px-3 cursor-pointer rounded-tr-md md:hover:bg-field_hover"
