  ...
  return (
    <main>
      <Container className="flex flex-col justify-center items-center h-full">
        <div className="max-w-4xl mx-auto mt-24" aria-hidden="true">
        ...
        <p className="text-center text-lg text-text_color mt-3 font-semibold" role="status" aria-live="polite">-- Offline --</p>
