import { LinkButtonOutline, LinkButtonSolid } from "./_components/Button"

export default function AdminDashboard() {

    return (
        <div className="w-full flex flex-col gap-3 px-6 py-10 max-w-3xl mx-auto">            
            <LinkButtonOutline linkto='add_edit/add_user' className="w-full" buttonText="Add User" />
            <LinkButtonOutline linkto='add_edit/edit_user'  className="w-full" buttonText="Edit User" />
