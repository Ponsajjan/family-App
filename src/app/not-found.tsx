...
export default function Page() {
  ...
  if (hasToken) {
    return (
      <div className='text-text_color flex justify-center items-center w-full bg-main_background h-screen'>
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" viewBox="0 0 24 24" fill="none">
            ...
            21.6834 22.7071 21.2929L20.1716 18.7574ZM13 16C13 14.3431 14.3431 13 16 13C17.6569 13 19 14.3431 19 16C19 17.6569 17.6569 19 16 19C14.3431 19 13 17.6569 13 16Z" fill="rgba(var(--text-color))" />
          </svg>
        </span>
