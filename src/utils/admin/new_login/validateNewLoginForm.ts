...
export const validateNewLoginForm = (formData:NewLoginFormValueTypes) => {
    const errorMessage: NewLoginFormErrorTypes = {};
    ...
    if (formData.member_password === formData.moderator_password) errorMessage.password = "Member and Moderator password can't be the same";
    if (!formData.member_password || !formData.moderator_password) errorMessage.password = "Member and Moderator password is required";
